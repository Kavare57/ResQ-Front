...
import '../../../../core/api/operador_emergencia_api.dart';
import '../../../../core/services/storage_service.dart';
import '../../../auth/presentation/pages/login_page.dart';

class PerfilOperadorEmergenciaPage extends StatefulWidget {
  ...
  const PerfilOperadorEmergenciaPage({
    super.key,
    this.forzarCompletar = false,
  });

  @override
  State<PerfilOperadorEmergenciaPage> createState() =>
      _PerfilOperadorEmergenciaPageState();
}

class _PerfilOperadorEmergenciaPageState
    extends State<PerfilOperadorEmergenciaPage> {
